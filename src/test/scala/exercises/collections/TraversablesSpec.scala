...
class TraversablesSpec extends FlatSpec with Matchers {
  ...
  it should "chained two case fragment" in {
    val list = List(4, 6, 7, 8, 9, 13, 14)
  ...
  it should "not map the values" in {
    val list = List(4, 6, 7, 8, 9, 13, 14)
